...
public class DriveServiceHelper {
        ...
        return Tasks.call(mExecutor, new Callable<String>() {
            ...
            public String call() throws Exception {
                File metadata = new File()
                        ...
                        .setLastModifyingUserName("Untitled file");
     ...
     * contents.
     */
    public Task<Pair<String, String>> readFile(String fileIdParam) {
        fileId = fileIdParam;
        return Tasks.call(mExecutor, new Callable<Pair<String, String>>() {
            ...
            public Pair<String, String> call() throws Exception {
                ...
                String name = metadata.getLastModifyingUserName();
     ...
     * content}.
     */
    public Task<Void> saveFile(String fileIdParam, String nameParam, String contentParam) {
        name = nameParam;
        ...
        return Tasks.call(mExecutor, new Callable<Void>() {
            ...
            public Void call() throws Exception {
                ...
                File metadata = new File().setLastModifyingUserName(name);
     ...
     */
    public Task<Pair<String, String>> openFileUsingStorageAccessFramework(ContentResolver contentResolverParam, Uri uriParam) {
